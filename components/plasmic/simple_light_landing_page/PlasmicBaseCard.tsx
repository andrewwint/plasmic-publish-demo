...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: EMJiff0DUM0aMo/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__y0DE7, {
          [sty.freeBoxlong__y0DE72Xusf]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__vqcGp, {
            [sty.freeBoxlong__vqcGp2Xusf]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__suX8)}
                role={"img"}
              />
            ),
