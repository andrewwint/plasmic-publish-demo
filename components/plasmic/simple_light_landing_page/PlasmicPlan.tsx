...
import BaseCard from "../../BaseCard"; // plasmic-import: EMJiff0DUM0aMo/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: 9sElbUuxv6-x86/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nNj1F)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ifOrC)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__jfMZu)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet___0JtY9)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__dKaM)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__lBeU)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__nUjak)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___68Ela)}
