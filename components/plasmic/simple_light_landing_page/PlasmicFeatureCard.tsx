...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: zBJ0gPFvZ9UXy/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__dOPr, {
            [sty.freeBoxlong__dOPrVyLs]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__a1YT6, {
              [sty.freeBoxlong__a1YT6VyLs]: hasVariant(variants, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___4SWc9)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ag16X, {
          [sty.freeBoxlong__ag16XVyLs]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___1IUh, {
            [sty.freeBoxlong___1IUhVyLs]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__vwGvx)}
                role={"img"}
              />
            ),
