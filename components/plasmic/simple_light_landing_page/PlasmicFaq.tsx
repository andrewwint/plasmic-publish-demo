...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: 32_TbbMTwSc6t3/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rZ5Re)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__raEf)}>
          <div className={classNames(projectcss.all, sty.freeBox__hXoLj)}>
            {p.renderPlasmicSlot({
