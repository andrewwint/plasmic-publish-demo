...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: rwan4Zifc1I2b/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: Pgabtu6Zhl38QB/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vq397)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__tsJ3)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__xd4N6)}>
          <SphereIcon
