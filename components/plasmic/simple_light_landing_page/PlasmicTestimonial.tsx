...
import Avatar from "../../Avatar"; // plasmic-import: p6Lz842wBqy-H0/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 4_gLtA0zF9MEMW/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: Shs1kfSc_oYD8X/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dyON)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gIddu)}
        >
          <div
            className={classNames(
              projectcss.all,
